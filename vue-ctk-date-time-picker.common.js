...
// CONCATENATED MODULE: ./src/VueCtkDateTimePicker/index.vue?vue&type=template&id=0bc2b2c5&
...
var VueCtkDateTimePickervue_type_script_lang_js_getDefaultLocale = function getDefaultLocale() {
  VueCtkDateTimePickervue_type_script_lang_js_hasWindowAvailable().then(function () {
...
var VueCtkDateTimePickervue_type_script_lang_js_hasWindowAvailable = function hasWindowAvailable() {
...
/* harmony default export */ var VueCtkDateTimePickervue_type_script_lang_js_ = ({
  ...
  mounted: function mounted() {
    ...
    VueCtkDateTimePickervue_type_script_lang_js_hasWindowAvailable().then(function () {
      VueCtkDateTimePickervue_type_script_lang_js_updateMomentLocale(_this2.locale, _this2.firstDayOfWeek);
      _this2.pickerPosition = _this2.getPosition();
      _this2.pickerOpen = _this2.open;

      if (_this2.hasCustomElem) {
        _this2.addEventToTriggerElement();

        if (!_this2.noValueToCustomElem) {
          _this2.setValueToCustomElem();
        }
      }

      _this2.isMounted = true;

      if (_this2.format === 'YYYY-MM-DD hh:mm a' && _this2.onlyTime) {
